...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -4721.409190484928; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -8864.836306640518; // x position of the perpendicular encoder (in tick units)
    }
